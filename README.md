...
│   │   ├── hosting_siparisler.dart    # Hosting siparişleri modeli
...
**Toplam Dosya Sayısı:** 37+ dart dosyası + db.json + mock server configuration  
